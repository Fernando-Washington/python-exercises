# Preciso realizar um cálculo de médida aritrimetrica entre 3 notas de um aluno e exibila para o usuário, para isso vamos utilizar as operações básicas de soma e divisão.
